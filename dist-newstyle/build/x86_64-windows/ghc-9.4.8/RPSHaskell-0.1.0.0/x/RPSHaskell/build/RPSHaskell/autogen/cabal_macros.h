...
/* package RPSHaskell-0.1.0.0 */
#ifndef VERSION_RPSHaskell
#define VERSION_RPSHaskell "0.1.0.0"
#endif /* VERSION_RPSHaskell */
#ifndef MIN_VERSION_RPSHaskell
#define MIN_VERSION_RPSHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_RPSHaskell */
...
#define CURRENT_COMPONENT_ID "RPSHaskell-0.1.0.0-inplace-RPSHaskell"
